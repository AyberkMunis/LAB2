...
public class TestExample {
	...
	public void testAll(){
		...
		// 5.1) Create a multiplit and some additional sink
		...
		// 5.2) Change the system including the multisplit
		src.connect(r);
		r.connect(ms);
		ms.connect(t,0);
		ms.connect(sinkC,1);
		...
		// 8) simulate with check of simulation parameters against 
